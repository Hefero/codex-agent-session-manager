...
Next likely work:
1. Confirm Phase 4 reload is present and callable when the controller asks.
2. Implement codex_session_continue after idle/stable boundary.
3. Tie reload plus continuation into a proof flow.
